      ...
      000036 15 30                  257 	goto	00001$
                                    258 ;	main.c: 69: color_t orange_color = {.r = 32, .g = 8, .b = 0};
      000038 20 2F                  259 	mov	a, #0x20
      00003A 83 0B                  260 	mov	_orange_color+1, a
      00003C 08 2F                  261 	mov	a, #0x08
      00003E 82 0B                  262 	mov	_orange_color+0, a
      000040 04 13                  263 	clear	_orange_color+2
                                    264 ;	main.c: 70: color_t blue_color = {.r = 0, .g = 0, .b = 64};
      000042 06 13                  265 	clear	_blue_color+1
      000044 05 13                  266 	clear	_blue_color+0
      000046 40 2F                  267 	mov	a, #0x40
      000048 87 0B                  268 	mov	_blue_color+2, a
                                    269 ;	main.c: 71: color_t bright_orange_color = {.r = 80, .g = 32, .b = 16};
      ...
      000054 8A 0B                  275 	mov	_bright_orange_color+2, a
                                    276 ;	main.c: 72: color_t bright_blue_color = {.r = 16, .g = 16, .b = 128};
      ...
      000022 28 31                  324 	goto	_main
                                    ...
                                    328 ;--------------------------------------------------------
                                    329 	.area CODE
                                    330 ;	main.c: 92: void touch_init() {
                                    331 ;	-----------------------------------------
                                    332 ;	 function touch_init
                                    333 ;	-----------------------------------------
      00008A                        334 _touch_init:
                                    335 ;	main.c: 94: TS = TS_TP_CLK_IHRC_DIV2 | TS_TP_VREF_VCC05 | TS_DISCHARGE_WAIT_128CLOCKS;
      00008A 13 2F                  336 	mov	a, #0x13
      00008C A0 01                  337 	mov.io	__ts, a
                                    338 ;	main.c: 95: TPS2 = TPS2_TOUCH_TYPE_B | TPS2_VREFNONFLOAT_ALWAYS_ON;
      00008E 41 2F                  339 	mov	a, #0x41
      000090 A8 01                  340 	mov.io	__tps2, a
                                    341 ;	main.c: 96: PAC &= ~(BTN_bm); // Pin 4 as in
      000092 11 1D                  342 	set0.io	__pac, #4
                                    343 ;	main.c: 97: PADIER &= ~(BTN_bm | CS_bm); // Disable digital input for touch and CS pins
      000094 CD 01                  344 	mov.io	a, __padier
      000096 6F 2C                  345 	and	a, #0x6f
      000098 8D 01                  346 	mov.io	__padier, a
                                    347 ;	main.c: 98: }
      00009A 7A 00                  348 	ret
                                    349 ;	main.c: 100: void copy_to_buff(color_t pixel, uint8_t len)
                                    350 ;	-----------------------------------------
                                    351 ;	 function copy_to_buff
                                    352 ;	-----------------------------------------
      00009C                        353 _copy_to_buff:
                                    354 ;	main.c: 102: for (uint8_t i = 0; i < len; i++)
      ...
      0000A6                        361 00120$:
                                    362 ;	main.c: 104: pixel_buff[i].r = pixel.r;
      ...
      0000BE 80 03                  375 	idxm	p, a
                                    376 ;	main.c: 105: pixel_buff[i].g = pixel.g;
      ...
      0000CE 80 03                  384 	idxm	p, a
                                    385 ;	main.c: 106: pixel_buff[i].b = pixel.b;
      ...
      00013E DD 30                  510 	goto	00104$
                                    511 ;	main.c: 164: case 0:
      000140                        512 00101$:
                                    513 ;	main.c: 165: copy_to_buff(off_color, LED_COUNT);
      ...
      000158 4E 30                  526 	goto	_copy_to_buff
                                    527 ;	main.c: 166: return;
      00015A 7A 00                  528 	ret
                                    529 ;	main.c: 167: case 1:
      00015C                        530 00102$:
                                    531 ;	main.c: 168: copy_to_buff(blue_color, LED_COUNT);
      ...
      000174 4E 38                  544 	call	_copy_to_buff
                                    545 ;	main.c: 169: bright = bright_blue_color;
      ...
      000188 A8 39                  555 	call	___memcpy
                                    556 ;	main.c: 170: break;
      00018A DD 30                  557 	goto	00104$
                                    558 ;	main.c: 171: case 2:
      00018C                        559 00103$:
                                    560 ;	main.c: 172: copy_to_buff(orange_color, LED_COUNT);
      ...
      0001A4 4E 38                  573 	call	_copy_to_buff
                                    574 ;	main.c: 173: bright = bright_orange_color;
      ...
      0001DA 7A 00                  611 	ret
                                    612 ;	main.c: 181: case 1:
      0001DC                        613 00105$:
                                    614 ;	main.c: 182: pixel_buff[3] = bright;
      ...
      0001EE A8 31                  624 	goto	___memcpy
                                    625 ;	main.c: 183: break;
      0001F0 7A 00                  626 	ret
                                    627 ;	main.c: 184: case 3:
      0001F2                        628 00106$:
                                    629 ;	main.c: 185: pixel_buff[2] = bright;
      ...
      000204 A8 31                  639 	goto	___memcpy
                                    640 ;	main.c: 186: break;
      000206 7A 00                  641 	ret
                                    642 ;	main.c: 187: case 4:
      000208                        643 00107$:
                                    644 ;	main.c: 188: pixel_buff[1] = bright;
      ...
      00021A A8 31                  654 	goto	___memcpy
                                    655 ;	main.c: 189: break;
      00021C 7A 00                  656 	ret
                                    657 ;	main.c: 191: case 7:
      00021E                        658 00109$:
                                    659 ;	main.c: 192: pixel_buff[0] = bright;
      ...
      000282 A8 0B                  748 	mov	_touch_base+1, a
                                    749 ;	main.c: 254: __engint();
      000284 78 00                  750 	engint
                                    751 ;	main.c: 256: start_tone_out_startup();
      000286 74 38                  752 	call	_start_tone_out_startup
                                    753 ;	main.c: 258: while (1)
      000288                        754 00102$:
      000288 44 31                  755 	goto	00102$
                                    756 ;	main.c: 260: }
      00028A 7A 00                  757 	ret
                                    758 ;	main.c: 262: void interrupt(void) __interrupt(0)
                                    759 ;	-----------------------------------------
      ...
      000290 72 00                  765 	push	af
                                    766 ;	main.c: 265: if (INTRQ & INTRQ_TM3) // Timer3 interrupt request
      000292 C5 1B                  767 	t1sn.io	__intrq, #7
      000294 A4 31                  768 	goto	00121$
      000296                        769 00177$:
                                    770 ;	main.c: 269: uint16_t touch_value = read_touch_raw();
      ...
      00029C B6 0B                  774 	mov	_interrupt_sloc2_1_0+1, a
                                    775 ;	main.c: 271: if (touch_value == last_touch){
      ...
      0002B2                        789 00102$:
                                    790 ;	main.c: 274: resample_count = 0;
      0002B2 2B 13                  791 	clear	_resample_count+0
                                    792 ;	main.c: 275: last_touch = touch_value;
      ...
      0002BC                        797 00103$:
                                    798 ;	main.c: 278: if (resample_count >= RESAMPLE_BASE_COUNT) {
      ...
      0002C4                        803 00180$:
                                    804 ;	main.c: 279: touch_base = touch_value;
      ...
      0002CA A8 0B                  808 	mov	_touch_base+1, a
                                    809 ;	main.c: 280: resample_count = 0;
      0002CC 2B 13                  810 	clear	_resample_count+0
      0002CE                        811 00105$:
                                    812 ;	main.c: 286: if (touch_value < touch_base - TOUCH_THRESHOLD)
